...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-hdy9c7m.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-hdy9c7m.containers.anotherwebservice.com/
...
```
git clone git@github.com:Skype-Skype/container-hdy9c7m.git
cd container-hdy9c7m
```
...
```
docker attach container-hdy9c7m
```
